...
namespace Hsinpa.Winweed
{
    ...
    public class WinWeedGeneratorV2 : MonoBehaviour
    {
        ...
        public Bounds bounds => m_weedTerrainBuilderV2.TerrainSRP.Bounds;
        ...
        private async void Start() {
            ...
            m_weedGeneratorHelper = new WeedGeneratorHelper(material, transfrom_bound, SEGMENT, SEGMENT, wind_config, GetPainteWeedStruct);
